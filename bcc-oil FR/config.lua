...
---------------------------------- Translate Here! ---------------------------------------------
Config.Language = {
ManagerBlip = 'Gérant de la compagnie pétrolière', -- Nom du repère du gestionnaire
ManagerDrawText = 'Gérant de la compagnie, appuyez sur "G" pour ouvrir le menu',
OilManagerMainMenuName = 'Compagnie pétrolière',
BuyWagonMenuName = 'Acheter un wagon pétrolier ?',
OilWagonBought = 'Vous avez acheté un wagon pétrolier !',
OilWagonAlreadyBought = 'Vous possédez déjà un wagon pétrolier !',
SellOilWagon = 'Vendre votre wagon pétrolier ?',
NotEnoughCash = 'Vous n\'avez pas assez d\'argent !',
WagonSold = 'Wagon vendu',
NoWagontoSell = 'Vous n\'avez pas de wagon à vendre',
WagonSpawned = 'Votre wagon a été livré ! Cherchez le repère',
SpawnOilWagon = 'Appeler votre wagon pétrolier ?',
NoWagonOwned = 'Vous ne possédez pas de wagon',
WagonInSpawnLocation = 'Impossible de faire apparaître, un autre wagon est trop proche de l\'emplacement !',
Supplymenuname = 'Menu des fournitures',
OilMenuName = 'Menu pétrolier',
BuySupplyWagon = 'Acheter un wagon de fournitures ?',
SupplyWagonBought = 'Vous avez acheté un wagon de fournitures !',
SupplyWagonAlreadyBought = 'Vous possédez déjà un wagon de fournitures !',
SellSupplyWagon = 'Vendre votre wagon de fournitures ?',
SpawnSupplyWagon = 'Appeler votre wagon de fournitures ?',
FillYourOilWagon = 'Allez à l\'emplacement pour remplir votre wagon de pétrole !',
FillBlipName = 'Remplissez votre wagon de pétrole ici',
FillingOilwagon = 'Remplissage du wagon de pétrole',
GoDeliver = 'Rendez-vous à l\'emplacement et livrez le pétrole. Cela a été marqué sur votre carte',
DeliverBlipName = 'Emplacement de livraison',
OilDelivered = 'Pétrole livré !',
UnloadingOil = 'Transfert de pétrole',
ReturnOilWagon = 'Rendez-vous à la compagnie pétrolière et ramenez votre wagon au stockage !',
ReturnBlip = 'Point de retour',
CollectOilDeliveryPay = 'Allez voir le gérant de la compagnie et récupérez votre salaire !',
ThankYouHeresYourPayOil = 'Merci ! Voici votre récompense pour un travail bien fait !',
CooldownActive = 'Vous avez récemment effectué un travail pour moi, attendez un moment',
Missionfailed = 'Mission échouée',
SupplyWagonMisisonBegin = 'Rendez-vous au marqueur sur votre carte et récupérez les fournitures',
Pickupsupplyblip = 'Récupérez les fournitures ici',
Fillingsupplywagon = 'Remplissage du wagon de fournitures',
Grabbingsupplies = 'Ramassage des fournitures',
Putsuppliesonwagon = 'Maintenant, emportez les fournitures dans votre wagon',
DeliverSupplies = 'Rendez-vous au marqueur et livrez les fournitures',
Suppliesdelivered = 'Fournitures livrées, retournez voir le gérant du pétrole pour recevoir votre salaire',
GetSuppliesFromWagon = 'Allez récupérer les fournitures du wagon',
ReturnSupplyWagon = 'Retournez votre wagon à la compagnie pétrolière',
AlreadyInMission = 'Vous êtes déjà en mission',
CriminalPedBlip = 'Repère de criminels', -- Nom du repère criminel
CriminalDrawText = 'Appuyez sur "G" pour ouvrir le menu',
NUISellOilWagon = 'Vendre le wagon pétrolier pour ',
NUIBuyOilWagon = 'Acheter un wagon pétrolier pour ',
NUIDeliverMission = 'Mission de livraison ?',
NUIBuySupplyWagon = 'Acheter un wagon de fournitures pour ',
NUISellSupplyWagon = 'Vendre un wagon de fournitures pour ',
NUIExitMenu = 'Quitter le menu',
NUIRobOilCompany = 'Cambrioler la compagnie pétrolière',
NUIRobOilWagon = 'Voler un wagon pétrolier',
NUIOilMenu = 'Menu pétrolier',
NUISupplyMenu = 'Menu des fournitures',
RobOilWagonOpeningtext = 'J\'ai marqué l\'emplacement du wagon, allez-y et volez-le !',
RobOilWagonKillGaurds = 'Tuez les gardes !!',
RobOilWagonReturnWagon = 'Maintenant, emmenez le wagon à l\'emplacement de dépôt !',
RobOilWagonReturnBlip = 'Emplacement de dépôt',
RobOilWagonSuccess = 'Vous avez réussi à voler le wagon ! Bon travail, voici votre salaire !',
RobOilCoBlip = 'Cambrioler la compagnie pétrolière',
RobberySuccess = 'Vous avez cambriolé la compagnie pétrolière, fuyez maintenant !',
PressGToLockPick = 'Appuyez sur "G" pour crocheter',
DefendAgainstAttackers = 'Vous êtes attaqué, défendez-vous !',
Cooldown = 'A été cambriolé récemment',
SniffOil = 'Appuyez sur "G" pour renifler le pétrole !',
RobberyTitle = 'Cambriolage !',
BoughtTitle = 'Wagon acheté',
bought_desc = 'Le joueur a acheté un wagon de fournitures, ID statique du personnage : ',
bought_desc2 = 'Le joueur a acheté un wagon pétrolier, ID statique du personnage : ',
SoldTitle = 'Wagon vendu',
sold_desc = 'Le joueur a vendu un wagon pétrolier, ID statique du personnage : ',
sold_desc2 = 'Le joueur a vendu un wagon de fournitures, ID statique du personnage : ',
DeliveryMissionTitle = 'Livraison commencée',
Delivery_desc = 'Le joueur a commencé à livrer du pétrole, ID statique du personnage : ',
Delivery_desc2 = 'Le joueur a commencé à livrer des fournitures, ID statique du personnage : ',
Robbery_desc = 'Le joueur a commencé à cambrioler la compagnie pétrolière, ID statique du personnage : ',
Robbery_desc2 = 'Le joueur a commencé à voler un wagon pétrolier, ID statique du personnage : ',
SupplyWagonBlipName = 'Wagon de fournitures', -- Nom du repère du wagon de fournitures
OilWagonBlipName = 'Wagon pétrolier' -- Nom du repère du wagon pétrolier
