...
Config.Language = {
    ...
    TreasurePromptTitle = 'Recherchez des indices dans le coffre',
    TreasurePrompt_search = "Rechercher le coffre",
    TalkToNPCText = 'Appuyez sur "G" pour voir ce que Madame Nazar propose',
    Menu_Title_Hint = 'Boutique d\'indices',
    Menu_Title_Sell = 'Vendre',
    Menu_Title_Buy = 'Acheter',
    Menu_SubTitle_Hint = 'Conseils d\'achat',
    Menu_SubTitle_Sell = 'Vendre des articles',
    Menu_SubTitle_Buy = 'Acheter des articles',
    SubMenu_Head_Hint = "Acheter des conseils",
    Nazar = 'Madame Nazar',
    SubMenu_Head_Sell = "Vendre des articles",
    SubMenu_Head_Buy = "Acheter des articles",
    SubMenu_Hint = 'Acheter un indice ',
    Shopmenu_sell = "Vendre",
    Shopmenu_for = " pour ",
    Shopmenu_buy = "Acheter",
    input_button = "confirmer",
    input_placeholder = "insérer le montant",
    input_header = "montant",
    HintNotify = "Un indice vers un trésor a été marqué",
    NoHintNotify = "Je n'ai rien à proposer pour le moment, revenez plus tard",
    NoItem = "Vous n'avez pas cet article.",
    NoMoney = "Vous n'avez pas assez de liquidités.",
    NoGold = "Vous n'avez pas assez d'or", -- ajouté par mrtb
    NoChest = "Quelqu'un a déjà pillé ce coffre !",
    Alreadylooted = "Vous avez pillé le coffre !",
    ChestLooted = 'Objets reçus : ',
    
    Ramassage = "Récupérer la carte",
    YouCollected = "Vous avez récupéré une carte",
    CardCollected = "Carte collectée",
    CantCollectCard = "Cette carte a été récupérée par quelqu'un récemment et vous devez attendre",
    StackFull = "Vous ne pouvez plus transporter cet objet",
    InvFull = "Vous ne pouvez plus transporter"
