...
Config.Texts = {
AddDetails = "Ajouter des détails de la scène",
NoAuth = "Vous n'êtes pas le propriétaire de cette scène",
SceneErr = "Vous devez activer la scène pour placer du texte",
MenuTitle = "Éditeur de scène",
MenuSubCompliment = "Texte actuel : ",
Delete = "Supprimer",
Edit = "Modifier",
Font = "Changer de police",
Scale = "Changer l'échelle",
Color = "Changer la couleur",
BackgroundColor = "Changer la couleur de fond",
Exit = "Quitter"
}
