...
------------------- Translate Here -----------------------
Config.Language = {
RobberyStart = 'Cambriolage commencé !',
OnCooldown = 'Cela a été cambriolé récemment !',
LootMarked = 'Commencez à piller !',
HoldOutBeforeLooting = 'Attendez',
HoldOutBeforeLooting2 = 'minutes avant le pillage',
RobberyFail = 'Échec du cambriolage !',
Rob = 'Crochetage',
Robbery = 'Coffre-fort',
PickFailed = 'Échec du crochetage, serrure cassée',
RobberyEnable = 'Cambriolages activés, tirez avec une arme à un endroit valide pour commencer un cambriolage !',
RobberyDisable = 'Cambriolages désactivés',
WrongJob = 'Vous ne pouvez pas commencer de cambriolages en raison de votre emploi !'
